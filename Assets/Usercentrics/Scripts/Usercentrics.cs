...
namespace Unity.Usercentrics
{
    ...
    public class Usercentrics : Singleton<Usercentrics>
    {
        ...
        [SerializeField] public string GeoRuleSetID = "";
        [SerializeField] public UsercentricsOptions Options = new UsercentricsOptions();
#if UNITY_EDITOR
        [InspectorLink] [SerializeField] internal string ConfigurationDashboard = "https://admin.usercentrics.com";
        ...
        public void Initialize(
            ...
            var optionsInternal = UsercentricsOptionsInternal.CreateFrom(Options, SettingsID, GeoRuleSetID);
        ...
        public void ShowFirstLayer(UnityAction<UsercentricsConsentUserResponse> onDismissCallback)
        {
            ...
            ensureInitialized();
            var isSystemBackButtonDisabled = Options.disableSystemBackButton;
            this.onDismissCallback = onDismissCallback;
            UsercentricsPlatform?.ShowFirstLayer(isSystemBackButtonDisabled);
        }
